...
from questions import questions1, questions5, questions2, questions3, questions4, questionsTraining
...
def design2():
    ...
    for image in images:
        ...
        image_id = x[0]
        print(image_id)
        stim = visual.TextStim(win, questions2.questions_list2[image_id][0],
                               color=(1, 1, 1), colorSpace='rgb')
        # show question
        stim.draw()
        t = win.flip()
