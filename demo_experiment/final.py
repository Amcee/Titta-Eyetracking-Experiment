...
from questions import questions1, questions2, questions3, questions4, questions5
...
myMouse = event.Mouse(visible=True)  # Define mouse and make it so Mouse is visible
