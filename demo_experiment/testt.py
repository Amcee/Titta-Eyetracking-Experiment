...
def design(design_id):
    if design_id == 1:
        ...
        text = "For this design you will hear the question at any time before opening the dialogue to answer"
    ...
    for image in images:
        ...
        # for designs 3,4 show instructions
            ...
            stim = visual.TextStim(win, 'Click the left mouse button to see the image',
                                   color=(1, 1, 1), colorSpace='rgb')
        # for design 5 show different instruction and play sound once
        elif design_id == 5:
        ...
        while buttons != [1, 0, 0]:
            buttons = myMouse.getPressed()
            # for design 5 we need to check if s gets pressed then play sound
            if design_id == 5:
